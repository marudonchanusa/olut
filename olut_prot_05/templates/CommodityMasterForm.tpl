...
<tr><td>
  ...
  <table border="0" cellpadding="5">
    ...
    <tr>
      ...
      <td nowrap class="input_cell"><input type="text" class="hankaku" name="next_unit_price" value="{$post.next_unit_price|escape}" size="12" maxlength="10" onkeypress="javascript:moneyonly();"></td>
    </tr>
