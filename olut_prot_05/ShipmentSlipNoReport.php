...
*
*   Program name:
*    店票毎荷渡明細書書 - ShipmentSlipNoReport.php
*
*   Release History:
*    2005/09/30  ver 1.00.00 Initial Release
*    2005/10/19  ver 1.00.01 1.Skip login when URL parameter.
*                            2.Added code= parameter.
*
*/

session_cache_limiter('none');
include('sys_define.inc');
include(OLUT_DIR . "ShipmentSlipNoReportClass.php");
