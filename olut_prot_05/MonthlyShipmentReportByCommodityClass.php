...
*    2005/10/25  ver 1.00.02 Added line total.
*
*/
...
class MonthlyShipmentReportByCommodity extends OlutApp
{
        ...
        do
        {
            ...
            for($month=1; $month<=12; $month++)
            {
                if($month == $this->sql->record[3])
                {
                    ...
                    //
                    $line_price_total  += $this->sql->record[5];
                    $line_amount_total += $this->sql->record[4];
            ...
            //
            //
            $this->writeUpperCell(14,number_format($line_price_total));    // 金額
            $this->writeLowerCell(14,number_format($line_amount_total));   // 数量            
            //
            //
        } while($rc == true);
    ...
    */
    ...
    function printTotal()
    {
        ...
        //
        $this->writeUpperCell(14,number_format($grand_total));
    }
    /*
    *   商品名など、ヘダーに1行だけ書く。
    */
