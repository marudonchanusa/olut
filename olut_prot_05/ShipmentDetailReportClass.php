 ...
 *    2005/10/20  ver 1.00.05 用度品のトータルが無かった。
 *    2005/10/21  ver 1.00.06 1. 食肉などのトータルを追加。
 *                            2. ソートを店舗内部門を優先するように変更。
 *    2005/12/05  ver 1.00.07 Added paramter support.
 *    2005/12/09  ver 1.00.08 店舗トータルで消費税計算。店舗名サプレス。
 *
 */
...
class ShipmentDetailReport extends OlutApp
{
    ...
    */
    ...
    function printStoreTotal()
    {
        ...
        $this->pdf->Write(20,OlutApp::formatNumber($this->totals['仮勘定'],10));

        //
        //  酒類
        //
        $this->pdf->SetXY($this->x_pos[3],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->totals['酒類'],10));
        //
        //  鮮魚
        //
        $this->pdf->SetXY($this->x_pos[4],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->totals['鮮魚'],10));
        //
        //  ＴＯ
        //
        $this->pdf->SetXY($this->x_pos[5],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->totals['ＴＯ'],10));
        //
        //  食肉
        //
        $this->pdf->SetXY($this->x_pos[6],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->totals['食肉'],10));
        //
        //  材料費計。
        //
        ...
        // 2005/10/21
        // 配列のサイズが同じならば単なる加算で計算してくれるが、
        // 配列のサイズが違うと、以下のように、それぞれ加算しないと駄目なようです。
        //
    ...
    */
    ...
    function printIsdcdTotalLine($dv)
    {
        ...
        //
        $this->pdf->SetXY($this->x_pos[2],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($dv->totals['仮勘定'],10));

        //
        //  酒類
        //
        $this->pdf->SetXY($this->x_pos[3],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($dv->totals['酒類'],10));
        //
        //  鮮魚
        //
        $this->pdf->SetXY($this->x_pos[4],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($dv->totals['鮮魚'],10));
        //
        //  ＴＯ
        //
        $this->pdf->SetXY($this->x_pos[5],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($dv->totals['ＴＯ'],10));
        //
        //  食肉
        //
        $this->pdf->SetXY($this->x_pos[6],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($dv->totals['食肉'],10));
    ...
    function printCompanyTotalLine($material_total,$total,$supply_total,$totals,$tax)
    {
        ...
        //
        $this->pdf->SetXY($this->x_pos[2],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($totals['仮勘定'],10));
        //
        //  酒類
        //
        $this->pdf->SetXY($this->x_pos[3],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($totals['酒類'],10));
        //
        //  鮮魚
        //
        $this->pdf->SetXY($this->x_pos[4],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($totals['鮮魚'],10));
        //
        //  ＴＯ
        //
        $this->pdf->SetXY($this->x_pos[5],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($totals['ＴＯ'],10));
        //
        //  食肉
        //
        $this->pdf->SetXY($this->x_pos[6],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($totals['食肉'],10));
        //
        //  材料費計。
        //
        $this->pdf->SetXY($this->x_pos[7],$this->current_y);
    ...
    function printMonthlyTotal()
    {
        ...
        //
        $this->pdf->SetXY($this->x_pos[2],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->monthly_totals['仮勘定'],10));

        //
        //  酒類
        //
        $this->pdf->SetXY($this->x_pos[3],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->monthly_totals['酒類'],10));
        //
        //  鮮魚
        //
        $this->pdf->SetXY($this->x_pos[4],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->monthly_totals['鮮魚'],10));
        //
        //  ＴＯ
        //
        $this->pdf->SetXY($this->x_pos[5],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->monthly_totals['ＴＯ'],10));
        //
        //  食肉
        //
        $this->pdf->SetXY($this->x_pos[6],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($this->monthly_totals['食肉'],10));
        //
        //  材料費計。
        //
        $this->pdf->SetXY($this->x_pos[7],$this->current_y);
    ...
    */
    ...
    function printLine($values)
    {
        ...
        $this->supply_total += $v;
        $this->isdcd_supply_total   += $v;  // $this->supply_total; 間違っていた。 2005/10/21 fix.       
        //
        $this->pdf->SetXY($this->x_pos[8],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($v,10));
