 ...
 *
 *   Program name:
 *    出荷表示確認 - ShipmentDisplay.php
 *
 *   Release History:
 *    2005/09/30  ver 1.00.00 Initial Release
 *    2005/10/26  ver 1.00.01 表示のときに請求書印刷ボタンを追加。 => .tpl
 *
 */
...
include(OLUT_DIR . 'ShipmentDisplayClass.php');
...
{
    // インスタンス生成。
    $obj =& new ShipmentDisplay();

    if(isset($_POST['find']) || isset($_POST['prev']) || isset($_POST['next']))
    {
        $obj->find($_POST);
    }
