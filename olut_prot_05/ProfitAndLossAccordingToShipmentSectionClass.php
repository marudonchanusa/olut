 ...
 *    2005/10/05  ver 1.00.01 Added month selection screen.
 *    2005/10/26  ver 1.00.02 減耗が計算されなくなった不具合を修正。
 *
 */
...
class ProfitAndLossAccordingToShipmentSection_Smarty extends Smarty
{
    function ProfitAndLossAccordingToShipmentSection_Smarty()
    {
...
class ProfitAndLossAccordingToShipmentSection extends OlutApp
{
    ...
    function ProfitAndLossAccordingToShipmentSection()
    {
        ...
        $this->tpl =& new ProfitAndLossAccordingToShipmentSection_Smarty();
    ...
    */
    ...
    function renderScreen($formvars)
    {
        ...
        $this->tpl->display('ProfitAndLossAccordingToShipmentSectionForm.tpl');
    }
    /*
    *  日付け関係の設定。
    */
    ...
    function setupDates($formvars)
    {
        ...
        // 減耗が出なくなったのは、日付けのゼロが無かったことが原因。
        // 
        if($this->target_month < 10)
        {
            $this->target_month = '0' . $this->target_month;
        }
    }
    ...
    */
    ...
    //
    //      2005/10/26 注意：　Depletion flag の設定について。
    // 
    //      以下のようなsqlで減耗フラグをセットすること。
    //      update m_commodity set depletion_flag='1' where code='50002' or code='60002' or code='70002' or 
    //                  code='75002' or code='29800' or code='39800' or code='49800' or code='89800';
    //      上記以外の商品は 減耗フラグ 0でないと駄目。
    //
