...
class InventoryEntry_SQL extends SQL
{
    function InventoryEntry_SQL()
    {
    	//
...
class InventoryEntry_Smarty extends Smarty
{ 
    function InventoryEntory_Smarty()
    {
