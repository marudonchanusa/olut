 ...
 *
 *   Program name:
 *    入出荷実績表示 - ArrivalShipmentCheck.php
 *
 *   Release History:
...
include(OLUT_DIR . 'ArrivalShipmentCheckClass.php');
...
if( $login->validateUser($_POST) == true)
{
    ...
    if(isset($_SESSION['is_commodity_ref']))
    {
        ...
        if(isset($commodityRef->commodity_code))
        {
            ...
            $obj->commodity_unit_price = $commodityRef->commodity_unit_price;
            $obj->commodity_unit_name  = $commodityRef->commodity_unit_name;
