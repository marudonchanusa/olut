<?php /* Smarty version 2.6.9, created on 2005-10-08 07:34:59
...
" size="12" maxlength="10" onkeypress="javascript:moneyonly();"></td>
    ...
    <tr>
      ...
      <td nowrap class="input_cell"><input type="text" class="hankaku" name="next_unit_price" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['post']['next_unit_price'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" size="12" maxlength="10" onkeypress="javascript:moneyonly();"></td>
    </tr>
