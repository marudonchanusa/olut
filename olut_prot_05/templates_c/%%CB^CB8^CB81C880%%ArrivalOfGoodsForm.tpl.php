<?php /* Smarty version 2.6.9, created on 2005-10-27 02:55:00
         compiled from ArrivalOfGoodsForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ArrivalOfGoodsForm.tpl', 24, false),array('modifier', 'escape', 'ArrivalOfGoodsForm.tpl', 126, false),)), $this); ?>
<html>
<head>
...
" size="8" maxlength="7" onkeypress="javascript:digitonly();" >
    <?php if ($this->_tpl_vars['modify_mode'] == true): ?>
...
">
  ...
  <input type="submit" name="check" value="　確認　" style="width:80px;" <?php echo $this->_tpl_vars['button_state']; ?>
>
  <INPUT TYPE="SUBMIT" VALUE="保存" name="save" style="width:80px;" <?php echo $this->_tpl_vars['button_state']; ?>
>
  <?php if ($this->_tpl_vars['modify_mode'] == true): ?>
    <INPUT TYPE="SUBMIT" VALUE="削除" name="delete" style="width:80px;" onclick="return confirm('削除して宜しいですか？');" <?php echo $this->_tpl_vars['button_state']; ?>
>
  <?php endif; ?>  
  <hr size="1">
<!--  </form> -->
