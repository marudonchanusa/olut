<?php /* Smarty version 2.6.9, created on 2005-07-25 15:59:36
         compiled from CommodityReferenceForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'CommodityReferenceForm.tpl', 62, false),)), $this); ?>
<html>
<head>
...
<table border="0" cellpadding="3" cellspacing="0" bgcolor="#808080">
  ...
  <table border="0" width="600">
    <tr>
      ...
      <td bgcolor="#FFCCCC" width="190">商品名</td>
      <td bgcolor="#FFCCCC" width="1">　</td>
      <td bgcolor="#FFCCCC" width="1">　</td>
      <td nowrap bgcolor="#FFCCCC" width="1">　</td>
      <td bgcolor="#FFCCCC" width="60">コード</td>
      <td bgcolor="#FFCCCC" width="200%">商品名</td>
    </tr>
...
?>
    ...
    <tr>
      ...
      <td nowrap bgcolor="#FFFFFF" width="1"><input type="radio" name="commodity_code" value="<?php echo $this->_tpl_vars['post'][$this->_sections['item']['index']][0]; ?>
"></td>
      ...
      <td nowrap bgcolor="#FFFFFF" width="1"><input type="radio" name="commodity_code" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['post'][$this->_sections['item']['index']][0])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"></td>
      <td nowrap bgcolor="#FFFFFF" width="60"><?php echo ((is_array($_tmp=$this->_tpl_vars['post'][$this->_sections['item']['index']][0])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
　</td>
