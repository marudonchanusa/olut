<?php /* Smarty version 2.6.9, created on 2005-07-25 15:48:12
         compiled from VendorReferenceForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'VendorReferenceForm.tpl', 62, false),)), $this); ?>
<html>
<head>
...
?>
    ...
    <tr>
      ...
      <td nowrap bgcolor="#FFFFFF" width="1"><input type="radio" name="vendor_code" value="<?php echo $this->_tpl_vars['post'][$this->_sections['item']['index']][0]; ?>
"></td>
      ...
      <td nowrap bgcolor="#FFFFFF" width="1"><input type="radio" name="vendor_code" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['post'][$this->_sections['item']['index']][0])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"></td>
      <td nowrap bgcolor="#FFFFFF" width="60"><?php echo ((is_array($_tmp=$this->_tpl_vars['post'][$this->_sections['item']['index']][0])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
　</td>
