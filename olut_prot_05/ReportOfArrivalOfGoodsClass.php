...
*    2005/11/30  ver 1.00.02 Decimal point of unit price is set to 2.
*    2005/12/01  ver 1.00.03 Added parameter support. 
*
*/
...
class ReportOfArrivalOfGoods extends OlutApp
{
    ...
    var $lines = 0;                     // 印刷行数。
    var $page_no = 1;
    var $target_code;                   // URL パラメータ指定時にコードを保持。
    ...
    */
    ...
    function printLine($rec,$print_vendor)
    {
        ...
        //
        $this->pdf->SetXY($this->x_pos[4],$this->current_y);
        $this->pdf->Write(20,OlutApp::formatNumber($rec[4],11,2));  //  単価 2005/11/30 小数点以下２桁に変更。
