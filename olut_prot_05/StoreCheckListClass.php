...
*
*   Program name:
*    店舗チェックリスト - StoreCheckListClass.php
*
*   Release History:
...
class StoreCheckList_Smarty extends Smarty
{
    function StoreCheckList_Smarty()
    {
...
class StoreCheckList_SQL extends SQL
{
    function StoreCheckList_SQL()
    {
        //
...
class StoreCheckList extends OlutApp
{
    var $sql;
    var $tpl;
    ...
    {
        $this->sql =& new StoreCheckList_SQL();
        $this->tpl =& new StoreCheckList_Smarty();
    }
    ...
    function printOut($formvars)
    {
        ...
        //
        $_query  = "select code, name from m_store order by code";
