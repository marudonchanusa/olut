...
<input type="submit" name="next" value="次表示→"> 
 店舗コード：<input type="text" class="hankaku" name="search_code" value=""  size="10" maxlength="5">
...
<tr><td>
  ...
  <table border="0" cellpadding="5">
    ...
    <tr>
      ...
      <td nowrap class="input_cell"><input type="text" class="hankaku" name="isdcd" value="{$post.isdcd|escape}" size="21" maxlength="15" onkeypress="javascript:digitonly();"></td>
    </tr>    
