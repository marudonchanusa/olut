...
<TR>
  ...
  <TD nowrap>
    <input type="text" class="hankaku" name="store_code" value="{$store_code}" size="8" maxlength="5" onkeypress="javascript:digitonly();" onBlur="javascript:refer_store(this.form,this);">
    <input type="submit" name="store_ref" value="参照">
    <!-- <input type="submit" name="store_check" value="表示">   --> 
  </TD>
  <td nowrap><span id=store_name>{$store_name}</span></td>
</tr>
<TR>
...
<tr><td>
  ...
  <table border="0" cellpadding="2" width="100%">
    ...
    <tr>
      ...
      <td nowrap class="data_cell" width="10%">
        <input type="text" class="money" name="total_price_{$n}" value="{$total_price[item]|escape}" size="8" maxlength="9"  onBlur="javascript:blur_submit_for_ship(this.form,this);" onkeypress="javascript:digit_and_sign();">
      </td>
