...
<table border="0" cellpadding="3" cellspacing="0" bgcolor="#808080">
  ...
  <table border="0" width="600">
    ...
    <tr>
      ...
      <td nowrap bgcolor="#FFFFFF" width="1"><input type="radio" name="store_code" value="{$post[item][0]}"></td>
      ...
      <td nowrap bgcolor="#FFFFFF" width="1">{$smarty.section.item.index+1}</td>
      <td nowrap bgcolor="#FFFFFF" width="1"><input type="radio" name="store_code" value="{$post[item][0]|escape}"></td>
      <td nowrap bgcolor="#FFFFFF" width="60">{$post[item][0]|escape}　</td>
