 ...
 *    2005/10/08  ver 1.00.01 Print process target month.
 *
 */
...
{
    $pd = $_SESSION['process_target'];
    //$year = 0;
    //$month = 0;
    //$login->getCurrentProcessDate($login->sql,$year,$month);
    /// $pd = "$year 年 $month 月";
?>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="500">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF" colspan="2" align="center">
        <font size="4">◆◆　　業務選択　[<?php print $pd ?>]　◆◆</font>
        <hr>
      </td>
