...
class ShipmentSlipNoReport extends OlutApp
{
    ...
    */
    ...
    function printHeader($formvars)
    {
        ...
        // 
        //  パラメータ起動の場合、フォーム変数では動かない。修正。2005/10/19.
        //
        ...
        {
            $target_year  = $this->target_year;  // formvars['target_year'];
            $target_month = $this->target_month; // formvars['target_month'];
        }
    ...
    */
    ...
    function printData($formvars)
    {
        ...
        // パラメータ指定で target_code を指定できるようにした。2005/10/19.
        ...
        $_query .= " group by sd.code, sd.name, st.name, st.code,act_date,slip_no,st.isdcd ";
        $_query .= " order by st.isdcd, st.code, sd.code, act_date, slip_no";
