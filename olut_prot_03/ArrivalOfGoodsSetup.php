...
class ArrivalOfGoods_SQL extends SQL
{
    function ArrivalOfGoods_SQL()
    {
    	//
...
class ArrivalOfGoods_Smarty extends Smarty
{ 
    function ArrivalOfGoods_Smarty()
    {
