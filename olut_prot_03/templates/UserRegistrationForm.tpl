...
<TR>
  <TD>新ユーザーID</TD>
  <TD VALIGN=TOP><INPUT TYPE="text" class="hankaku" NAME="new_userid" value="{$new_userid}"SIZE="32" MAXLENGTH="8" ></TD>
</tr>
...
<tr>
  ...
  <TD VALIGN=TOP>
    <INPUT TYPE="text" NAME="screen_lines" class="hankaku" SIZE="5" MAXLENGTH="2" value="{$screen_lines}" onkeypress="javascript:digitonly();"><BR>
  </TD>
</tr>
